...
if($session->logged_in){
		$title = "View 2.1 Full video (high quality)";		
		include '../head.php';
...
?>
    ...
    <script type="text/javascript">
				...
				{
				newwindow=window.open(url,'name','height=730,width=705','scrollbars=no','toolbar=no','menubar=no','location=no','status=no');
	...
	<p>	
		<a href="6_multd_dmult_21_l_all.php">Low Res</a> . <strong>High Res</strong> |&nbsp;<a href="../6/index.php">6th Grade</a> . <a href="../7/index.php">7th Grade</a> . <a href="../8/index.php">8th Grade</a><br>
	</p>
	</div>

	<h2 style="padding-top:20px;">Developing an Algorithm for Decimal Multiplication</h2>
	<p style="text-align:center"><i>Bits and Pieces III, Problem 2.1</i></p>
...
<option value="">Chapter 3</option>
			...
			<td valign="top"><p>Click on problem(s) to enlarge.</p>
            	<a href="javascript:poptastic('img/bp3_prob2_1.jpg');"><img  border="0" width="275" src="img/bp3_prob2_1.jpg" /></a><br />
