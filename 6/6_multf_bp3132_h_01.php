...
if($session->logged_in){
		...
		include '../head.php';
		$url = encode("6_multf_bp3132_h_01.flv");
...
?>
    ...
    <script type="text/javascript">
				...
				{
				newwindow=window.open(url,'name','height=720,width=640','scrollbars=no','toolbar=no','menubar=no','location=no','status=no');
				if (window.focus) {newwindow.focus()}
				}
	</script>
	...
	<p style="text-align:center"><i>Bits and Pieces II, Problems 3.1 & 3.2</i></p>
	<table cellspacing="10" >
		<tr>
			<td valign="top"><br /><embed src="../player/mediaplayer/player.swf" width="316" height="250"
                                ...
                                <p>Currently Viewing: Chapter 1</p>
...
<option value="6_multf_bp3132_h_03.php">Chapter 3</option>
			...
			<td valign="top"><p>Click on problem(s) to enlarge.</p>
                    ...
                    <a href="javascript:poptastic2('img/bp2_prob3_2.jpg');"><img  border="0" width="275" src="img/bp2_prob3_2.jpg" /></a>
