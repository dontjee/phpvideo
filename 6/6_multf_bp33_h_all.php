...
if($session->logged_in){
		$title = "View Bits and Pieces 3.3  Full video (high quality)";		
		include '../head.php';
		$url = encode("6_multf_bp33_h_all.flv");
...
<script type="text/javascript">
	...
	<p>	
		<a href="6_multf_bp33_l_all.php">Low Res</a> . <strong>High Res</strong> |&nbsp;<a href="../6/index.php">6th Grade</a> . <a href="../7/index.php">7th Grade</a> . <a href="../8/index.php">8th Grade</a><br>
	</p>
	</div>
    
    
	<h2 style="padding-top:20px;">Developing an Algorithm for Fraction Multiplication</h2>
	<p style="text-align:center"><i>Bits and Pieces II, Problem 3.3</i></p>
...
<option value="">Chapter 3</option>
			...
			<td valign="top"><p>Click on problem(s) to enlarge.</p>
            	<a href="javascript:poptastic('img/bp2_prob3_3.jpg');"><img  border="0" width="275" src="img/bp2_prob3_3.jpg" /></a>
