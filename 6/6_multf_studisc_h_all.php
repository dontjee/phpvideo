...
if($session->logged_in){
		$title = "View Student Discourse Full video (high quality)";		
		include '../head.php';
		$url = encode("6_multf_studisc_h_all.flv");
...
<script type="text/javascript">
	...
	<p>	
		<a href="6_multf_studisc_l_all.php">Low Res</a> . <strong>High Res</strong> |&nbsp;<a href="../6/index.php">6th Grade</a> . <a href="../7/index.php">7th Grade</a> . <a href="../8/index.php">8th Grade</a><br>
	</p>
	</div>


	<h2 style="padding-top:20px;">Developing an Algorithm for Fraction Multiplication</h2>
	<p style="text-align:center"><i>Student Discourse</i></p>
