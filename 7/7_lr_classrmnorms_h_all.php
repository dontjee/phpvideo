...
if($session->logged_in){
		$title = "Establishing Classroom Norms  Full video (high quality)";		
		include '../head.php';
		$url = encode("7_lr_classrmnorms_h_all.flv");
...
<script type="text/javascript">
	...
	<p style="text-align:center"><i>Establishing Classroom Norms</i></p>
