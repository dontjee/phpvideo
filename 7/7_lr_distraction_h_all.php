...
if($session->logged_in){
		$title = "View Distration or Learning Opportunity? Full video (high quality)";		
		include '../head.php';
		$url = encode("7_lr_distraction_h_all.flv");
...
<script type="text/javascript">
				...
				{
				newwindow=window.open(url,'name','height=515,width=760','scrollbars=no','toolbar=no','menubar=no','location=no','status=no');
	...
	<p style="text-align:center"><i>Distraction or Learning Opportunity?</i></p>
...
<p>Questions about the problem.
			...
			<td valign="top"><p>Click on problem(s) to enlarge.</p>
            	<a href="javascript:poptastic('img/msa_problem2_1.jpg');"><img  border="0" width="275" src="img/msa_problem2_1.jpg" /></a>
