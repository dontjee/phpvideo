...
if($session->logged_in){
		$title = "View Some Management Issues: Home and Vocabulary  Full video (high quality)";		
		include '../head.php';
		$url = encode("7_lr_mgmt_h_all.flv");
...
<script type="text/javascript">
	...
	<p style="text-align:center"><i>Some Management Issues: Homework and Vocabulary</i></p>
