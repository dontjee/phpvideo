...
if($session->logged_in){
		$title = "View Say it with Symbools, Investigation 1.1  Full video (high quality)";		
		include '../head.php';
		$url = encode("8_eqrep_siws11_h_all.flv");
...
<script type="text/javascript">
				...
				{
				newwindow=window.open(url,'name','height=500,width=815','scrollbars=no','toolbar=no','menubar=no','location=no','status=no');
	...
	<h2 style="padding-top:20px;">Equivalent Representations</h2>
	<p style="text-align:center"><i>Say it with Symbols, Investigation 1.1</i></p>
...
<p>Questions about the problem.
			...
			<td valign="top"><p>Click on problem(s) to enlarge.</p>
            	<a href="javascript:poptastic('img/siws_prob1_1.jpg');"><img  border="0" width="275" src="img/siws_prob1_1.jpg" /></a>
