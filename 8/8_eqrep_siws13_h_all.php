...
if($session->logged_in){
		$title = "View Say it with Symbools, Investigation 1.3  Full video (high quality)";		
		include '../head.php';
		$url = encode("8_eqrep_siws13_h_all.flv");
...
<script type="text/javascript">
	...
	<p style="text-align:center"><i>Say it with Symbols, Investigation 1.3</i></p>
...
<p>Questions about the problem.
			...
			<td valign="top"><p>Click on problem(s) to enlarge.</p>
            	<a href="javascript:poptastic('img/siws_prob1_3.jpg');"><img  border="0" width="275" src="img/siws_prob1_3.jpg" /></a>
