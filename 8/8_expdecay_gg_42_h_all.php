...
if($session->logged_in){
		$title = "View Growing, Growing, Growing, Investigation 4.2  Full video (high quality)";		
		include '../head.php';
		$url = encode("8_expdecay_gg_42_h_all.flv");
...
<script type="text/javascript">
				...
				{
				newwindow=window.open(url,'name','height=1350,width=760','scrollbars=no','toolbar=no','menubar=no','location=no','status=no');
	...
	<p style="text-align:center"><i>Growing, Growing, Growing, Investigation 4.2</i></p>
...
<p>Questions about the problem.
			...
			<td valign="top"><p>Click on problem(s) to enlarge.</p>
            	<a href="javascript:poptastic('img/ggg_prob4_2.jpg');"><img  border="0" width="275" src="img/ggg_prob4_2.jpg" /></a>
